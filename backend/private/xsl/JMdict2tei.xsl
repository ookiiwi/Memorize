...
<!-- Here is the place to write the language of the dictionary you expect entry/sense/gloss@xml:lang-->
<xsl:param name="targetlang" select="'ger'"/>	
...
<text><body><xsl:text>&#xa;</xsl:text>
	<xsl:for-each select="entry">
		<xsl:if test="sense/gloss[($targetlang = 'eng' and not (@xml:lang)) or @xml:lang = $targetlang]">	
...
<xsl:template match="sense">
	<xsl:if test="gloss[($targetlang = 'eng' and not (@xml:lang)) or @xml:lang = $targetlang]">
...
<xsl:template match="gloss">
	<xsl:if test="($targetlang = 'eng' and not (@xml:lang)) or @xml:lang = $targetlang">
